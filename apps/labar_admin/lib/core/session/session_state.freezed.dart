...
abstract class $SessionStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SessionStatus status, UserEntity? user});
...
class _$SessionStateImpl implements _SessionState {
  const _$SessionStateImpl({this.status = SessionStatus.unknown, this.user});
...
abstract class _SessionState implements SessionState {
  const factory _SessionState(
      {final SessionStatus status,
      final UserEntity? user}) = _$SessionStateImpl;
